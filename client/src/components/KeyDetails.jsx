    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-panel p-6 sm:p-8 bg-[#202020] border-[#337418]/40">
        <div className="flex items-start gap-4">
          <div className="p-2.5 bg-[#0F0F0F] border border-[#5DD62C] rounded-xl text-[#5DD62C] shrink-0 shadow-[0_0_10px_rgba(93,214,44,0.2)]">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              ...
              <code className="font-mono text-[#5DD62C] bg-[#0F0F0F] px-1.5 py-0.5 rounded border border-[#337418]/30 text-xs">
                extractable: false
              </code>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-2 text-xs">
              <div className="p-3 bg-[#0F0F0F] rounded-xl border border-[#337418]/30 space-y-1">
                <div className="flex items-center gap-1.5 text-white font-semibold">
                  <Shield className="w-3.5 h-3.5 text-[#5DD62C]" />
                  <span>XSS Protection</span>
                </div>
                <p className="text-slate-400">
                  Rogue browser scripts cannot call <code className="font-mono text-[10px] text-[#5DD62C]">exportKey()</code> to steal your private key bytes.
                </p>
              </div>

              <div className="p-3 bg-[#0F0F0F] rounded-xl border border-[#337418]/30 space-y-1">
                <div className="flex items-center gap-1.5 text-white font-semibold">
                  <Cpu className="w-3.5 h-3.5 text-[#5DD62C]" />
              ...
              <div className="p-3 bg-[#0F0F0F] rounded-xl border border-[#337418]/30 space-y-1">
                <div className="flex items-center gap-1.5 text-white font-semibold">
                  <Layers className="w-3.5 h-3.5 text-[#5DD62C]" />
                  <span>Structured Persistence</span>
                </div>
                <p className="text-slate-400">
                  Keys are cloned into IndexedDB as opaque <code className="font-mono text-[10px] text-[#5DD62C]">CryptoKey</code> handles without exposing plaintext.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {/* ECDSA Signing JWK */}
        <div className="glass-panel p-5 bg-[#202020] border-[#337418]/40 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="p-2 bg-[#0F0F0F] border border-[#337418]/40 rounded-lg text-[#5DD62C]">
            ...
            >
              {copiedKey === 'ecdsa' ? (
                <Check className="w-3 h-3 text-[#5DD62C]" />
              ) : (
                <Copy className="w-3 h-3 text-[#5DD62C]" />
              )}
              <span>Copy</span>
            </button>
          </div>

          <pre className="p-3 bg-[#0F0F0F] border border-[#337418]/40 rounded-xl text-[11px] font-mono text-[#5DD62C] overflow-x-auto max-h-60 select-all leading-relaxed">
            {ecdsaFormatted}
          </pre>
        </div>
